...
const addVideoSummaryApi = matroid => {
  // https://app.matroid.com/docs/api/documentation#api-Video_Summary-GetSummariesSummaryid
  ...
  }; // https://app.matroid.com/docs/api/documentation#api-Video_Summary-GetSummariesSummaryidTracksCsv
  ...
  }; // https://app.matroid.com/docs/api/documentation#api-Video_Summary-GetSummariesSummaryidVideoMp4
  ...
  }; // https://app.matroid.com/docs/api/documentation#api-Video_Summary-PostSummarize
  ...
  }; // https://app.matroid.com/docs/api/documentation#api-Video_Summary-DeleteSummariesSummaryid
  ...
  }; // https://app.matroid.com/docs/api/documentation#api-Video_Summary-GetStreamsStreamidSummaries
  ...
  }; // https://app.matroid.com/docs/api/documentation#api-Video_Summary-PostStreamsStreamidSummarize
